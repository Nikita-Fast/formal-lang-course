...
from project.interpreter.memory import MemBox, MemoryList
from project.interpreter.utils.graph_loader import (
    load_from_disk,
    load_from_network,
)
...
from project.interpreter.utils.set_operations import *
from project.interpreter.utils.states_adder import *
from project.interpreter.utils.type_utils import *
from project.interpreter.utils.interpreter_except import InterpError
from project.interpreter.observer import ObserverOtput
...
class GQLTreeVisitor(grammarGQLVisitor):
    ...
    def visitGet_reachable(self, ctx: grammarGQLParser.Get_reachableContext):
        ...
        try:
            ...
            temp_bm = BooleanMatrices.from_automaton(source.value)
            matrix_tc = temp_bm.transitive_closure()
    ...
    def visitLoad(self, ctx: grammarGQLParser.LoadContext):
        ...
        dfa = graph_to_nfa(graph).to_deterministic()
