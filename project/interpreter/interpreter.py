...
from project.interpreter.GQLVisitor import GQLTreeVisitor
...
if __name__ == "__main__":
    ...
    test_interp.run_query(
        "let Ig1 = load graph '/home/nikita/PycharmProjects/Григорьев/formal-lang-course/tests/task_15/graphinterp.dot'\n"
    )
